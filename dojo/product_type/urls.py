...
urlpatterns = [
    ...
    re_path(r"^organization$", views.product_type, name="organization"),
    re_path(r"^organization/(?P<ptid>\d+)$", views.view_product_type, name="view_organization"),
    re_path(r"^organization/(?P<ptid>\d+)/edit$", views.edit_product_type, name="edit_organization"),
    re_path(r"^organization/(?P<ptid>\d+)/delete$", views.delete_product_type, name="delete_organization"),
    re_path(r"^organization/add$", views.add_product_type, name="add_organization"),
    re_path(r"^organization/(?P<ptid>\d+)/add_product", product_views.new_product,
            name="add_product_to_organization"),
