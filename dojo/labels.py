...
V2_LABELS = {
    ...
    _K.ORG_NOTIFICATION_WITH_NAME_CREATED_MESSAGE: _("Product Type %(name)s as been created successfully."),
    ...
    _K.ASSET_NOTIFICATION_WITH_NAME_CREATED_MESSAGE: _("Product %(name)s as been created successfully."),
...
V3_LABELS = {
    ...
    _K.ORG_NOTIFICATION_WITH_NAME_CREATED_MESSAGE: _("Organization %(name)s as been created successfully."),
    ...
    _K.ASSET_NOTIFICATION_WITH_NAME_CREATED_MESSAGE: _("Asset %(name)s as been created successfully."),
